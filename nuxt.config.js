...
module.exports = {
  ...
  */
  head: {
    ...
    meta: [
      ...
      { name: "keywords", content: "Mamba,曼巴,前端工程师,vue.js,node.js,博客网站" },
      { name: 'author', content: 'Mamba 曼巴' },
      { name: "description", content: "曼巴博客网站是我个人从需求分析、网页设计、创建项目、部署上线全栈搭建的第一个个人网站，我将会通过他来实践自己的所学，让自己得到成长，也希望借此结交更多前辈好友。也乐于分享我的博客网站在前端、node.js、设计和web的各个细节上的点点滴滴，愿与你有缘，共同进步！" },
  ...
  */
  axios: {
    baseURL: process.env.NODE_ENV === 'development' ? 'http://127.0.0.1:8727/web' : 'https://www.coco727.com/web',
    credentials: true
  },
  /*
  ** Build configuration
