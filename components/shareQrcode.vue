  ...
  <div class="">
    <div class="icon-box">
      ...
      <div :tabindex="0" class="dashang-box d-flex" @blur="showCode = false">
        <i
          class="iconfont cur-p dashang mx-5"
        ...
        <div v-show="showCode" class="rotate-box" :class="{'active-rotate': isRotate}">
          <div class="wxCode">
            <span class="btn cur-p" @click="isRotate =!isRotate">支</span>
            <h3 class="mt-0 fs-3xl">微信</h3>
            <img src="../assets/img/dashang.jpg" alt="打赏Mamba 曼巴" width="150px" />
            <div class="m-0 fs-2xl">赏我的人，长的真好看</div>
          </div>
          <div class="zfbCode">
            <span class="btn cur-p" @click="isRotate =!isRotate">微</span>
            <h3 class="mt-0 fs-3xl">支付宝</h3>
            <img src="../assets/img/zfb.png" alt="打赏Mamba 曼巴" width="150px" />
            <div class="m-0 fs-2xl">赏我的人，长的真好看</div>
          </div>
        </div>
      </div>
      <div :tabindex="0" class="QRcode-box d-flex" @blur="showCanvas = false">
        <i
          ...
          class="iconfont cur-p icon-weixin mx-5"
          title="微信分享"
      ...
      <el-tooltip class="item" effect="dark" content="后期补上" placement="top-start">
        <i class="iconfont cur-p icon-weibo mx-5" title="后期补上"></i>
      </el-tooltip>
      </div>
