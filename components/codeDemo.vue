<template>
  <div class="fs-3xl py-5 px-4">
    ...
    <img src="~/assets/img/me/lizi.jpg" alt="Mamba 曼巴" height="200">
    </div>
    ...
    <div class="text-center biaoqing">
      <p class="my-4">纳尼？</p>
      <img src="~/assets/img/me/nani.jpg" alt="Mamba 曼巴" height="200">  
      <p class="my-4">我也不知道想表达什么，我先干了这碗鸡汤啊，你们随意！</p>
      <img src="~/assets/img/me/jitang.jpg" alt="Mamba 曼巴" height="200">
