<template>
  <div class="mask_layer_model" style="z-index: 9;">
    <div class="captcha_model">
      ...
      <div class="content">
        <div class="top-refresh"><i class="el-icon-refresh" @click="onRefresh" title="刷新验证码"></i></div>
    ...
    <div id="randomPosX" style="display: none">{{randomPos.x}}</div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getRandomImgSrc() {
      ...
      return require(`./img/${this.getRandomNumberByRange(1, 10)}.jpg`);
    }
  }
};
</script>
